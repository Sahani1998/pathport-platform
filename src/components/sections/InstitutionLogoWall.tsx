...
export default async function InstitutionLogoWall() {
  ...
  return (
    <section className="py-12 border-t border-white/[0.05] overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        ...
        <div className="marquee-group relative">
          {/* Edge fades blend the loop into the page background */}
          <div aria-hidden className="absolute inset-y-0 left-0 w-16 md:w-24 z-10 bg-gradient-to-r from-[#06142E] to-transparent pointer-events-none" />
          <div aria-hidden className="absolute inset-y-0 right-0 w-16 md:w-24 z-10 bg-gradient-to-l from-[#06142E] to-transparent pointer-events-none" />
