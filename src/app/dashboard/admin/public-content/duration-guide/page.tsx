...
export default function DurationGuidePage() {
  ...
  const fetchRows = useCallback(async () => {
    ...
    try {
      ...
      console.log("[DurationGuide] querying public_page_sections where section_key='duration_guide'…");
      ...
      console.log(
        "[DurationGuide] result — rows:", data?.length ?? 0,
      ...
      console.error("[DurationGuide] unexpected exception:", msg);
      ...
      <div className="bg-white/[0.03] border border-white/[0.07] rounded-2xl overflow-hidden">
        {loading ? (
          <div className="flex items-center justify-center py-20 gap-3 text-white/35">
            ...
            <span className="font-body text-sm">Loading duration guide rows…</span>
          </div>
        ) : rows.length === 0 && !error ? (
