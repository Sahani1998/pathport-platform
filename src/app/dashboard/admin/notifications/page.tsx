...
export default async function AdminNotificationsPage() {
  ...
  if (error) console.error("[AdminNotifications] fetch error:", error.message);
  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      {/* List — admin uses the institution detail view (it allows admins) */}
      <NotificationList
        notifications={notifications}
        applicationBasePath="/dashboard/institution/applications"
      />
    </div>
  );
}
