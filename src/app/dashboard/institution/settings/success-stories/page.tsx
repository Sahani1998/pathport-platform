...
export const metadata = { title: "Success Stories — Institution" };
export const dynamic  = "force-dynamic";

export default async function SuccessStoriesSettingsPage() {
  ...
  const items = (rows ?? []) as SuccessStory[];
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        ...
        <h2 className="font-display text-3xl text-white mb-1">Success Stories</h2>
        <p className="text-white/40 font-body text-sm">
          Highlight alumni who have gone on to careers at top companies. Published success stories inspire prospective students on your public page.
        </p>
      </div>

      <StoriesManager storyType="success-story" initialItems={items} />
    </div>
  );
}
