...
export const metadata = { title: "Videos — Institution" };
...
export default async function VideosSettingsPage() {
  ...
  const items = (rows ?? []) as InstitutionVideo[];
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        ...
        <h2 className="font-display text-3xl text-white mb-1">Videos</h2>
        <p className="text-white/40 font-body text-sm">
          Add YouTube or Vimeo videos — campus tours, welcome messages, or programme overviews. Published videos appear on your public college page.
        </p>
      </div>
