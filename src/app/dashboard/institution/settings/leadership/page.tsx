...
export const metadata = { title: "Leadership Team — Institution" };
...
export default async function LeadershipSettingsPage() {
  ...
  const items = (rows ?? []) as LeadershipMember[];
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        ...
        <h2 className="font-display text-3xl text-white mb-1">Leadership Team</h2>
        <p className="text-white/40 font-body text-sm">
          Showcase your institution&apos;s leadership — Principal, Director, Dean, and other key figures. Published members appear on your public college page.
        </p>
      </div>

      <PersonManager personType="leadership" initialItems={items} />
    </div>
  );
}
