...
import FacilitiesManager from "@/components/media/FacilitiesManager";
import type { Facility } from "@/types/institution-trust";

export const metadata = { title: "Facilities — Institution" };
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        ...
        <h2 className="font-display text-3xl text-white mb-1">Facilities</h2>
        <p className="text-white/40 font-body text-sm">
          Showcase your campus facilities — labs, libraries, sports facilities, and more. Published facilities appear on your public college page.
        </p>
      </div>

      <FacilitiesManager initialItems={items} />
    </div>
  );
}
