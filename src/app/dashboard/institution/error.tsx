...
export default function InstitutionDashboardError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[InstitutionDashboard] error:", error.message);
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-5">
      ...
      <div className="text-center">
        <p className="font-display text-2xl text-white mb-2">Something went wrong</p>
