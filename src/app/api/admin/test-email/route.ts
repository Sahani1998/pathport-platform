...
const SAMPLE_CONTEXTS: Record<EmailTemplate, TemplateContext> = {
  ...
  payment_verified:             { name: "Priya Sharma", courseName: "Diploma in Business Management", collegeName: "PSB Academy", invoiceNumber: "DIM-INV-2026-0001", amount: "SGD 12,500.00" },
  payment_rejected:             { name: "Priya Sharma", courseName: "Diploma in Business Management", reason: "Transfer amount does not match invoice total. Expected SGD 12,500.00." },
  payment_info_requested:       { name: "Priya Sharma", courseName: "Diploma in Business Management", collegeName: "PSB Academy", message: "Please provide a clearer screenshot of the transfer confirmation showing the full amount and recipient details." },
  official_receipt_issued:      { name: "Priya Sharma", courseName: "Diploma in Business Management", collegeName: "PSB Academy", receiptNumber: "DIM-RCP-2026-0001", amount: "SGD 12,500.00" },
