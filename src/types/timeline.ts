...
export const STAGE_META: StageMeta[] = [
  ...
  { value: "ipa_processing",             label: "IPA Processing by ICA",   step: 10, emoji: "🪪", color: "text-purple-400   bg-purple-500/10    border-purple-400/25",         description: "Your college has submitted your IPA to ICA Singapore for processing."        },
...
export const STAGE_NOTIFICATION: Partial<Record<ApplicationStage, { title: string; message: string; type: NotificationType }>> = {
  ...
  ipa_processing:                { title: "IPA Processing Started 🪪",                 message: "Your college has submitted your IPA to ICA Singapore. Processing typically takes 2–4 weeks.",     type: "application_update" },
